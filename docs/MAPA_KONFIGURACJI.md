...
[FUNCTION_MAP.md](FUNCTION_MAP.md) — 802 funkcji w 37 modułach, generowana
...
| **drugi, niezależny egzemplarz tego samego uchwytu** | `browser.py:802` `PROFIL_HANDLE = "your-handle"` | KOD |
...
| 2 | **usunięcie `browser.PROFIL_HANDLE`** i podmiana 11 użyć na `config.SUBSTACK_HANDLE` | `browser.py:802` + 11 miejsc | zamiana identyfikatora, zero logiki |
