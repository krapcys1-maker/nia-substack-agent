...
[FUNCTION_MAP.md](FUNCTION_MAP.md) — 794 funkcji w 37 modułach, generowana
...
| `review` | deepseek-v4-pro | `recenzent.md` | 76 000 | 0,054 | `stages.review:217` |
...
| **drugi, niezależny egzemplarz tego samego uchwytu** | `browser.py:794` `PROFIL_HANDLE = "your-handle"` | KOD |
...
| 2 | **usunięcie `browser.PROFIL_HANDLE`** i podmiana 11 użyć na `config.SUBSTACK_HANDLE` | `browser.py:794` + 11 miejsc | zamiana identyfikatora, zero logiki |
