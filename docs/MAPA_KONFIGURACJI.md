...
[FUNCTION_MAP.md](FUNCTION_MAP.md) — 803 funkcji w 37 modułach, generowana
...
| `review` | deepseek-v4-pro | `recenzent.md` | 76 000 | 0,054 | `stages.review:226` |
...
| **drugi, niezależny egzemplarz tego samego uchwytu** | `browser.py:803` `PROFIL_HANDLE = "your-handle"` | KOD |
...
| 2 | **usunięcie `browser.PROFIL_HANDLE`** i podmiana 11 użyć na `config.SUBSTACK_HANDLE` | `browser.py:803` + 11 miejsc | zamiana identyfikatora, zero logiki |
