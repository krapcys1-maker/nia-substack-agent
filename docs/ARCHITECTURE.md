...
For the complete function-level inventory — 736 functions with line numbers,
...
agent-v2/              the bot. Everything that runs is here
  ...
  tests/               183 free tests, 9 paid ones in tests/platne/
...
Measured across the 736 functions:
