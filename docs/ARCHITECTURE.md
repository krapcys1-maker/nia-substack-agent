...
For the complete function-level inventory — 797 functions with line numbers,
...
agent-v2/              the bot. Everything that runs is here
  ...
  tests/               221 free tests, 9 paid ones in tests/platne/
...
| `run.py` | 2,843 | ~1,221 | 49% | orchestration |
...
Measured across the 797 functions:
