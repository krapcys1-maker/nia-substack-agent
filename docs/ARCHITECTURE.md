...
For the complete function-level inventory — 708 functions with line numbers,
...
agent-v2/              the bot. Everything that runs is here
  ...
  tests/               176 free tests, 9 paid ones in tests/platne/
...
Measured across the 708 functions:
