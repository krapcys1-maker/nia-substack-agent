...
For the complete function-level inventory — 794 functions with line numbers,
...
agent-v2/              the bot. Everything that runs is here
  ...
  tests/               216 free tests, 9 paid ones in tests/platne/
...
| `run.py` | 2,843 | ~1,216 | 49% | orchestration |
...
Measured across the 794 functions:
