...
For the complete function-level inventory — 798 functions with line numbers,
...
agent-v2/              the bot. Everything that runs is here
  ...
  tests/               222 free tests, 9 paid ones in tests/platne/
...
| `run.py` | 2,843 | ~1,222 | 49% | orchestration |
...
Measured across the 798 functions:
