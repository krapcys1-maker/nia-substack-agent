...
For the complete function-level inventory — 553 functions with line numbers,
...
agent-v2/              the bot. Everything that runs is here
  ...
  tests/               132 free tests, 9 paid ones in tests/platne/
...
Measured across the 553 functions:
