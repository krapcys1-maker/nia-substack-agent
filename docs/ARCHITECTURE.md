...
For the complete function-level inventory — 529 functions with line numbers,
...
agent-v2/              the bot. Everything that runs is here
  ...
  tests/               123 free tests, 10 paid ones in tests/platne/
...
Measured across the 519 functions:
