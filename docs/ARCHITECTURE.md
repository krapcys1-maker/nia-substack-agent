...
For the complete function-level inventory — 651 functions with line numbers,
...
agent-v2/              the bot. Everything that runs is here
  ...
  tests/               163 free tests, 9 paid ones in tests/platne/
...
Measured across the 651 functions:
