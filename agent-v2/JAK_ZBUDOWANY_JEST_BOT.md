...
|---|---|---|
| maksimum 10 plików `.py` | **32 plików**, 35 670 wierszy | **PRZEKROCZONE** |
...
się testować bez przeglądarki i bez pieniędzy**. 183 zestawów
...
472 wierszy, 19 funkcji na poziomie modułu, 0 klas
