...
|---|---|---|
| maksimum 10 plików `.py` | **37 plików**, 37 047 wierszy | **PRZEKROCZONE** |
...
testów, 4333 sprawdzeń, żaden nie otwiera Chrome i żaden nie
...
8668 wierszy, 150 funkcji na poziomie modułu, 0 klas
