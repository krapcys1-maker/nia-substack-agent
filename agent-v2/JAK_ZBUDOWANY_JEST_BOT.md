...
|---|---|---|
| maksimum 10 plików `.py` | **37 plików**, 36 944 wierszy | **PRZEKROCZONE** |
...
testów, 4319 sprawdzeń, żaden nie otwiera Chrome i żaden nie
...
5682 wierszy, 104 funkcji na poziomie modułu, 3 klas
