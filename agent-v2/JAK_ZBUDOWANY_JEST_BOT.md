...
|---|---|---|
| maksimum 10 plików `.py` | **25 plików**, 31 001 wierszy | **PRZEKROCZONE** |
...
się testować bez przeglądarki i bez pieniędzy**. 151 zestawów
testów, 3775 sprawdzeń, żaden nie otwiera Chrome i żaden nie
...
7809 wierszy, 137 funkcji na poziomie modułu, 0 klas
