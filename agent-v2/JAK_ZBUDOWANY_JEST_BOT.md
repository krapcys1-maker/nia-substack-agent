...
|---|---|---|
| maksimum 10 plików `.py` | **25 plików**, 29 204 wierszy | **PRZEKROCZONE** |
...
testów, 3492 sprawdzeń, żaden nie otwiera Chrome i żaden nie
...
2941 wierszy, 27 funkcji na poziomie modułu, 0 klas
