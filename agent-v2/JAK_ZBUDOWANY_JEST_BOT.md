...
|---|---|---|
| maksimum 10 plików `.py` | **25 plików**, 28 946 wierszy | **PRZEKROCZONE** |
...
testów, 3456 sprawdzeń, żaden nie otwiera Chrome i żaden nie
...
7312 wierszy, 133 funkcji na poziomie modułu, 0 klas
...
5197 wierszy, 96 funkcji na poziomie modułu, 0 klas
...
372 wierszy, 6 funkcji na poziomie modułu, 0 klas
...
313 wierszy, 4 funkcji na poziomie modułu, 0 klas
...
| `FETCH_USER_AGENT` | `"Mozilla/5.0 (compatible; YourPublication/1.` | — |
