...
def main() -> int:
    ...
    print()
    print("  3. THE AI-DISCLOSURE STATEMENT — one manual setting on the profile.")
    print("     Nothing in the code sets it, and nothing will tell you it is")
    print("     missing. Read agent-v2/prompts/OSWIADCZENIE_AUTORSTWA.md,")
    print("     decide what your account says when asked, and set it by hand.")
    print()
