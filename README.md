...
26 model roles · 128 tests · 16 gates on every finished text
```
...
| **[docs/FUNCTION_MAP.md](docs/FUNCTION_MAP.md)** | all **546 functions** in 25 modules — line, signature, whether it calls a paid model and for which stage, whether it touches the browser, who calls it. Generated from the AST |
