...
26 model roles · 157 tests · 12 gates on every finished text
```
...
| **[docs/FUNCTION_MAP.md](docs/FUNCTION_MAP.md)** | all **574 functions** in 25 modules — line, signature, whether it calls a paid model and for which stage, whether it touches the browser, who calls it. Generated from the AST |
...
(architecture with costs) and `JAK_ZBUDOWANY_JEST_BOT.md` — 12,078 lines,
...
Measured on this copy (2026-09-05): of 157 test files, **155 pass and 2 fail**;
