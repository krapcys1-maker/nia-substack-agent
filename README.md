...
26 model roles · 154 tests · 12 gates on every finished text
```
...
| **[docs/FUNCTION_MAP.md](docs/FUNCTION_MAP.md)** | all **571 functions** in 25 modules — line, signature, whether it calls a paid model and for which stage, whether it touches the browser, who calls it. Generated from the AST |
...
Measured on this copy (2026-09-05): of 154 test files, **152 pass and 2 fail**;
