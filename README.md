...
| **[docs/FUNCTION_MAP.md](docs/FUNCTION_MAP.md)** | all **556 functions** in 25 modules — line, signature, whether it calls a paid model and for which stage, whether it touches the browser, who calls it. Generated from the AST |
...
(architecture with costs) and `JAK_ZBUDOWANY_JEST_BOT.md` — 13,059 lines,
