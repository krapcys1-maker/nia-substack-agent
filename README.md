...
26 model roles · 163 tests · 12 gates on every finished text
```
...
(architecture with costs) and `JAK_ZBUDOWANY_JEST_BOT.md` — 12,240 lines,
...
Measured on this copy (2026-09-05): of 163 test files, **159 pass and 2 fail**;
