...
26 model roles · 146 tests · 12 gates on every finished text
```
...
(architecture with costs) and `JAK_ZBUDOWANY_JEST_BOT.md` — 11,857 lines,
...
Measured on this copy: of 146 test files, **137 pass, 2 skip themselves and 2
